...
const actions: (keyof ActionTypes)[] = [
  ...
  "view/SHOW_SEARCH_ASIDE",
  "view/HIDE_SEARCH_ASIDE",
  "view/SEARCH_FOCUS",
  ...
  "remotePlayback/remoteDesktop/DISCONNECT",
  "remotePlayback/remoteDesktop/STATE_CHANGED",
  "remotePlayback/remoteDesktop/MEDIA_CHANGED",
  "remotePlayback/remoteDesktop/STOP_BROADCASTING",
  ...
  "chromeCast/CUSTOM_MESSAGE_RECEIVED",
  ...
  "ROUTER_REPLACE_ROUTES",
  "ROUTER_DID_REPLACE_ROUTES",
  "windows/ACTIVATED",
  ...
  "user/UPDATE_PROFILE_META",
  "user/UPDATE_DATE_OF_BIRTH",
  "user/LOAD_USER",
  "user/LOAD_USER_SUCCESS",
  "user/LOAD_USER_FAIL",
  "user/ENABLE_FACEBOOK_LOGIN",
  "user/DISABLE_FACEBOOK_LOGIN",
  "user/RECEIVED_FACEBOOK_LOGIN_TOKEN",
  "user/RECEIVED_FACEBOOK_LOGIN_TOKEN_FOR_PROFILE_PICTURE",
  ...
  "user/PROFILE_PICTURE_UPLOAD_FAIL",
  "user/SAVE_PROFILE_SUCCESS",
  "user/SAVE_PROFILE_FAIL",
  ...
  "settings/LOAD_ACCOUNT_URLS",
  "settings/LOAD_ACCOUNT_URLS_SUCCESS",
  ...
  "session/CLIENT_AUTHORIZED",
  "session/CLIENT_DEAUTHORIZED",
  ...
  "session/DOLBY_ATMOS_SUPPORTED",
  "session/RECEIVED_COUNTRY_CODE",
  "session/STORE_GDRP_COOKIE_CONSENT",
  ...
  "session/UPDATE_API_TOKEN",
  "session/UPGRADE_TOKEN",
  ...
  "ADD_STREAMABLE_ITEMS_TO_QUEUE_SUCCESS",
  ...
  "playbackProgress/FAKE_LOCAL_PLAYBACK_PROGRESS",
  "playbackProgress/LOAD_PLAYBACK_PROGRESS",
  "playbackProgress/LOAD_PLAYBACK_PROGRESS_SUCCESS",
  ...
  "playbackControls/SET_QUALITY",
  "playbackControls/SET_STREAM_TYPE",
  ...
  "modal/SHOW_DEVICE_DETECTED",
  "modal/SHOW_OUTPUT_DEVICE_SETTINGS_MODAL",
  "modal/SHOW_RESTRICTED_ACCESS",
  ...
  "modal/SHOW_UPSELL_MODAL",
  "modal/SHOW_EXPLICIT_TOGGLE_MODAL",
  "modal/REMOTE_DESKTOP_DISCONNECT_MODAL",
  "modal/MQA_DIALOG_CONFIRM",
  ...
  "interruptions/SET_UNINTERRUPTED__TIME_PLAYED",
  "interruptions/AUTOMATIC_TRACK_PROGRESSION",
  "interruptions/LOAD_AND_PLAY_CURRENT_ITEM",
  "interruptions/ENABLE_INTERRUPTIONS_MODE",
  "interruptions/DISABLE_INTERRUPTIONS_MODE",
  "interruptions/REMOVE_FIRST_INTERRUPTION_IN_QUEUE",
  "interruptions/REMOVE_ALL_INTERRUPTIONS_IN_QUEUE",
  "interruptions/QUEUE_INTERRUPTION",
  "interruptions/ADD_ITEMS_TO_INTERRUPTIONS_ARRAY",
  "interruptions/PREMIUM_MODE",
  "interruptions/COUNT_ACTIVE_PLAY",
  "interruptions/setActivePlayCount",
  ...
  "featureFlags/HYDRATE_FEATURE_FLAGS",
  ...
  "eventTracking/TRACK_ITEM_BLOCK_EVENT",
  "eventTracking/OPEN_CONTEXT_MENU",
  "eventTracking/CREATE_NEW_PLAYLIST",
  "eventTracking/CREATE_NEW_FOLDER",
  ...
  "eventTracking/AD_INTERRUPTIONS",
  ...
  "content/LOAD_LIST_ITEMS_PAGE_SUCCESS_ALREADY_FULLY_LOADED",
  "content/LOAD_LIST_ITEMS_PAGE_FAIL",
  "content/LOAD_DYNAMIC_PAGE",
  "content/LOAD_DYNAMIC_PAGE_SKIP",
  ...
  "content/LOAD_DYNAMIC_ALBUM_PAGE",
  "content/LOAD_DYNAMIC_ARTIST_PAGE",
  ...
  "content/RESET_STATE_ON_NAVIGATE",
  ...
  "content/LOAD_CREATED_AND_FAVORITE_PLAYLISTS",
  "content/LOAD_CREATED_AND_FAVORITE_PLAYLISTS_SUCCESS",
  "content/LOAD_CREATED_AND_FAVORITE_PLAYLISTS_FAIL",
  ...
  "boombox/SET_AVAILABLE_DEVICES",
  "boombox/SET_ACTIVE_DEVICE",
  "boombox/SET_ACTIVE_DEVICE_SUCCESS",
  "boombox/SET_DEVICE_MODE",
  "boombox/SET_DEVICE_MODE_SUCCESS",
  "boombox/SET_FORCE_VOLUME",
  "boombox/SET_PASS_THROUGH",
  "boombox/SET_PASS_THROUGH_SUCCESS",
  "boombox/PRELOAD_NEXT_ITEM",
  "boombox/PRELOAD_SUCCESS",
  "boombox/ERROR",
  "boombox/ENSURE_PLAYBACK_PRIVILEGES",
  "boombox/STREAMING_PRIVILEGES_REVOKED",
  "blocks/BLOCK",

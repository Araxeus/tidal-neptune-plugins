...
`;var u=({value:t,onValue:e,title:o,tooltip:v})=>{const i=S(t),g=(r)=>{if(parseInt(r.target.value)<1){r.target.value="1",i(1);return}e?.(r.target.value)},m=(r)=>{r.preventDefault();const y=r.deltaY<0?1:-1,l=Math.min(20,Math.max(1,i()+y));i(l),e?.(l.toString())};return h`
		<${x} tooltip=${v}>
